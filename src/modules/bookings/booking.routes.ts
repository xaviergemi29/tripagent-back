  ...
  server.patch(
    ...
    async (request, reply) => {
      try {
        ...
        const result = await BookingService.cancelBooking(id, penaltyPercentage, AGENCY_ID);
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Error interno al procesar la cancelación";
