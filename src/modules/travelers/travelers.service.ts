...
import type { GetTravelersQuery, UpdateTravelerBody, CreateTravelerBody } from "./travelers.schema.js";
...
export class TravelerService {
   ...
   */
    ...
    static async getTravelerHistory(travelerId: string,  agencyId: string) {
        ...
        const lifetimeValue = traveler.bookings.reduce((sum, booking) => sum + Number(booking.amountPaid), 0);
        return {
            ...traveler,
            metrics: {
                totalTrips,
